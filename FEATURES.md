...
- Java IntelliSense/diagnostics for JSP scriptlets (`<% ... %>`) (planned)
...
- **JSP smart completions** for scriptlets/directives/expressions
  - No context-aware Java suggestions for `request`, `session`, `pageContext`, etc.
  - No import-aware suggestions from `<%@ page import="..." %>`
